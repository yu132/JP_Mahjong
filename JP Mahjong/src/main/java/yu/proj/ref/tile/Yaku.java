...
public enum Yaku {
    ...
    PREVALENT_WIND_E(ALL_1_HAN()), 
    PREVALENT_WIND_S(ALL_1_HAN()),
    PREVALENT_WIND_W(ALL_1_HAN()),
    PREVALENT_WIND_N(ALL_1_HAN()), // 场风
    
    SEAT_WIND_E(ALL_1_HAN()), 
    SEAT_WIND_S(ALL_1_HAN()), 
    SEAT_WIND_W(ALL_1_HAN()), 
    SEAT_WIND_N(ALL_1_HAN()), // 自风
    
    DRAGON_WH(ALL_1_HAN()), 
    DRAGON_G(ALL_1_HAN()), 
    DRAGON_R(ALL_1_HAN()), // 三元牌
