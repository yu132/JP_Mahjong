...
/**  
 * @ClassName: TestAnalyzeSingleWaitFourConcealedTriplets  
 *
 ...
 *  
 */
public class TestAnalyzeSingleWaitFourConcealedTriplets {
    ...
    public void test() {
        ...
        assertTrue(taData.bothContainYaku(Yaku.SINGLE_WAIT_FOUR_CONCEALED_TRIPLETS));
    }
