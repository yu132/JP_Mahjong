...
/**  
 * @ClassName: TestAnalyzeThreeConcealedTriplets  
 *
 ...
 *  
 */
public class TestAnalyzeThreeConcealedTriplets {
    ...
    public void test() {
        ...
        assertTrue(taData.yakuManager.getTsumoYakus().contains(Yaku.THREE_CONCEALED_TRIPLETS));
    ...
    public void test2() {
        ...
        YakuAnalyzeData yaData = taData.yaData(taData.getFirstTenpai(MAN_6), MAN_6);

        analyzer.analyzeYaku(yaData, taData.yakuManager);

        assertTrue(taData.bothContainYaku(Yaku.THREE_CONCEALED_TRIPLETS));
    }
